...
Auto-adding threads is based onlz on the last board and search string used.
...
In background.js, you might want to adjust these values (at risk of provoking 4chan):

✱ const MAX_CONCURRENT_THREADS = 5;
    Default value is 5.
    Number of max threads running at the same time.
    [Update] Now editable from the extension window.
